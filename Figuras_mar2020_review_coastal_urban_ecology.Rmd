...
subj <-ggplot(Anos_subj, aes(x = publication_year, y=N)) + geom_col(aes(fill=theme),position = "stack")+  labs(y="Number of articles", x="Publication year")  + theme_classic()+ ylim(c(0,45))+ scale_fill_brewer(palette = "Dark2") + theme(text=element_text(size=18,  family="Arial"))+ labs(fill="Study subject")
...
aprox <-ggplot(Anos_aprox, aes(x = publication_year, y=N)) + geom_col(aes(fill=approximation),position = "stack")+  labs(y="Number of articles", x="Publication year")  + theme_classic()+ ylim(c(0,45))+ scale_fill_brewer(palette = "Dark2") + theme(text=element_text(size=18,  family="Arial"))+ labs(fill="Approximation of study")
...
#legend_3 <- get_legend(Anos_comp) %>% as_ggplot()
#legend_4 <- get_legend(Anos_aprox) %>% as_ggplot()
# legend_5 <- get_legend(Anos_anal) %>% as_ggplot()
...
grid.arrange(subj, disc, comp, aprox, anal, ncol=1 )
...
study_model %in% c( "Sustainable cities","Eco-cities", "Green infrastructure", "Marine structures")~"Soc-eco-tecnological"))
...
ggplot(Años_model, aes(x = publication_year, y=N)) + geom_col(aes(fill=study_model_subject),position = "stack")+  labs(y="Number of articles", x="Publication year")  + theme_classic()+ ylim(c(0,45))+ scale_fill_brewer(palette = "Dark2") + theme(text=element_text(size=18,  family="Arial"))+ labs(fill="Study model")
